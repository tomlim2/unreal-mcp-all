 ...
 */
class MEGAMELANGE_API FMegaMelangeActorCommands
{
public:
	FMegaMelangeActorCommands();
...
private:
	...
	bool UpdateDoubleProperty(AActor* Actor, const FName& PropertyName, float NewValue);
	...
	// MM Control Light Commands (Create, Read, Update, Delete)
