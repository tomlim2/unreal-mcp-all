...
// JSON Utilities
TSharedPtr<FJsonObject> FMegaMelangeCommonUtils::CreateErrorResponse(const FString& Message)
{
...
TSharedPtr<FJsonObject> FMegaMelangeCommonUtils::CreateSuccessResponse(const TSharedPtr<FJsonObject>& Data)
{
	TSharedPtr<FJsonObject> ResponseObject = MakeShared<FJsonObject>();
...
void FMegaMelangeCommonUtils::GetIntArrayFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName, TArray<int32>& OutArray)
{
	OutArray.Reset();
...
void FMegaMelangeCommonUtils::GetFloatArrayFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName, TArray<float>& OutArray)
{
	OutArray.Reset();
...
FVector2D FMegaMelangeCommonUtils::GetVector2DFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
FVector FMegaMelangeCommonUtils::GetVectorFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
FRotator FMegaMelangeCommonUtils::GetRotatorFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
// Blueprint Utilities
UBlueprint* FMegaMelangeCommonUtils::FindBlueprint(const FString& BlueprintName)
{
	return FindBlueprintByName(BlueprintName);
}

UBlueprint* FMegaMelangeCommonUtils::FindBlueprintByName(const FString& BlueprintName)
{
	FString AssetPath = TEXT("/Game/Blueprints/") + BlueprintName;
	return LoadObject<UBlueprint>(nullptr, *AssetPath);
}

UEdGraph* FMegaMelangeCommonUtils::FindOrCreateEventGraph(UBlueprint* Blueprint)
{
	if (!Blueprint)
	{
		return nullptr;
...
UK2Node_Event* FMegaMelangeCommonUtils::CreateEventNode(UEdGraph* Graph, const FString& EventName, const FVector2D& Position)
{
	if (!Graph)
	{
		return nullptr;
...
UK2Node_CallFunction* FMegaMelangeCommonUtils::CreateFunctionCallNode(UEdGraph* Graph, UFunction* Function, const FVector2D& Position)
{
	if (!Graph || !Function)
	{
		return nullptr;
...
UK2Node_VariableGet* FMegaMelangeCommonUtils::CreateVariableGetNode(UEdGraph* Graph, UBlueprint* Blueprint, const FString& VariableName, const FVector2D& Position)
{
	if (!Graph || !Blueprint)
	{
		return nullptr;
...
UK2Node_VariableSet* FMegaMelangeCommonUtils::CreateVariableSetNode(UEdGraph* Graph, UBlueprint* Blueprint, const FString& VariableName, const FVector2D& Position)
{
	if (!Graph || !Blueprint)
	{
		return nullptr;
...
UK2Node_InputAction* FMegaMelangeCommonUtils::CreateInputActionNode(UEdGraph* Graph, const FString& ActionName, const FVector2D& Position)
{
	if (!Graph)
	{
		return nullptr;
...
UK2Node_Self* FMegaMelangeCommonUtils::CreateSelfReferenceNode(UEdGraph* Graph, const FVector2D& Position)
{
	if (!Graph)
	{
		return nullptr;
...
bool FMegaMelangeCommonUtils::ConnectGraphNodes(UEdGraph* Graph, UEdGraphNode* SourceNode, const FString& SourcePinName,
...
UEdGraphPin* FMegaMelangeCommonUtils::FindPin(UEdGraphNode* Node, const FString& PinName, EEdGraphPinDirection Direction)
{
	if (!Node)
	{
		return nullptr;
	...
	// Fallback: find first data output pin for variable get nodes
...
// Actor utilities
TSharedPtr<FJsonValue> FMegaMelangeCommonUtils::ActorToJson(AActor* Actor)
{
	if (!Actor)
	{
...
TSharedPtr<FJsonObject> FMegaMelangeCommonUtils::ActorToJsonObject(AActor* Actor, bool bDetailed)
{
	if (!Actor)
	{
		return nullptr;
...
UK2Node_Event* FMegaMelangeCommonUtils::FindExistingEventNode(UEdGraph* Graph, const FString& EventName)
{
	if (!Graph)
	{
		return nullptr;
