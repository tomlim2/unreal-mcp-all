...
def register_actor_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    def get_sky_settings(ctx: Context, sky_name: str) -> Dict[str, Any]:
        """Get the settings for a sky."""
        from unreal_mcp_server import get_unreal_connection
        
        unreal = get_unreal_connection()
        response = unreal.send_command("get_sky_settings", {"sky_name": sky_name})
    ...
    @mcp.tool()
    def set_sky_settings(ctx: Context, sky_name: str, settings: Dict[str, Any]) -> Dict[str, Any]:
        """Set the settings for a sky."""
        from unreal_mcp_server import get_unreal_connection
        
        unreal = get_unreal_connection()
        response = unreal.send_command("set_sky_settings", {"sky_name": sky_name, "settings": settings})
        return response
